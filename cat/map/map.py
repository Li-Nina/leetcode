...
def generate(maptype, attr, value, folder_type, label_name):
    split_number = 5  # 分段的个数
    max_value = cal_proper_max_value(max(value), split_number)
...
if __name__ == '__main__':
    ...
    generate('china', province_name, province_value, 'days', '单位(人天数)')
    for province in province_name:
        generate(province, city_name, city_value, 'days', '单位(人天数)')
